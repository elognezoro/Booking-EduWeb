...
import { FilePlus, Link2, ListChecks, ClipboardList } from "lucide-react";
...
/** Boutons d'ajout de contenu à une section : Page (texte enrichi), Média (URL), Quiz ou Devoir. */
export function ActivityAddButtons({ sectionId }: { sectionId: string }) {
  const [modal, setModal] = React.useState<null | "PAGE" | "URL" | "QUIZ" | "DEVOIR">(null);
  return (
    <>
