...
/** Accent visuel du Niveau 2 (cohérent avec CERTEL_LEVELS). */
export const N2_ACCENT = "#6D5DF5";

export interface N2ModuleMeta {
  num: number;
  code: string;
  slug: string;
  title: string;
...
export const N2_MODULES_META: N2ModuleMeta[] = ALL.map((m) => ({
...
export function getN2Module(slug: string): N1Module | undefined {
